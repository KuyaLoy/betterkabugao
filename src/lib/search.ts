...
const PAGES: SearchEntry[] = [
  ...
  { path: "/statistics", kind: "Page", title: "Kabugao statistics", summary: "Selected official census and POPCEN population observations, 1960–2024.", keywords: ["statistics", "population", "census", "popcen", "psa", "nso", "1960", "2024"] },
