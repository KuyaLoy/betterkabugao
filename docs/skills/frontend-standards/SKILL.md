...
1. Read `CLAUDE.md` (hard rules) and `docs/CONTEXT.md` (current state).
...
| Container | `--container: 1200px` | Network range is 1152–1280 |
...
contract tests: 18.0229° N, 121.1841° E · 135.7 m · 935.12 km² · 21 barangays ·
16,215 residents (2020 PSA census) · capital of Apayao. Any new figure needs a
named official source displayed next to it.
